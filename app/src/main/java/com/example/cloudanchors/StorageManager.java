...
class StorageManager {
    ...
    private String KEY_ROOT_DIR = "spiky";
...
//        DatabaseReference.goOnline();
    ...
    StorageManager(Context context, String room) {
        FirebaseApp firebaseApp = FirebaseApp.initializeApp(context);
        rootRef = FirebaseDatabase.getInstance(firebaseApp).getReference().child(room);
        DatabaseReference.goOnline();
    }

    void setRoomName(Context context, String room) {
        currentRoom = room;
        FirebaseApp firebaseApp = FirebaseApp.initializeApp(context);
        rootRef = FirebaseDatabase.getInstance(firebaseApp).getReference().child(room);
        DatabaseReference.goOnline();
